        ...
        <div style={{ position: 'relative', width: 160, height: 160 }}>
            <svg width="160" height="160" viewBox="0 0 160 160" style={{ fontFamily: 'sans-serif' }}>
                ...
                {[40, 60, 80, 100, 120].map(y => (
                    <React.Fragment key={`lpin-${y}`}>
                        <rect x="0" y={y-1.5} width="20" height="3" fill="#fbbf24" stroke="#d97706" strokeWidth="0.5" />
                        <circle cx="26" cy={y} r="2.5" fill="#0f172a" stroke="#fbbf24" strokeWidth="0.8" />
                    </React.Fragment>
                ))}
                ...
                {[20, 40, 60, 80, 100, 120, 140].map(y => (
                    <React.Fragment key={`rpin-${y}`}>
                        <rect x="140" y={y-1.5} width="20" height="3" fill="#fbbf24" stroke="#d97706" strokeWidth="0.5" />
                        <circle cx="134" cy={y} r="2.5" fill="#0f172a" stroke="#fbbf24" strokeWidth="0.8" />
                    </React.Fragment>
                ))}
