    ...
    return (
        <div style={{ position: 'relative', width: 50, height: 100 }}>
            ...
            >
                ...
                {/* Silver Header Pins */}
                <rect x="15" y="90" width="2" height="10" fill="#cbd5e1" rx="0.3" />
                <rect x="25" y="90" width="2" height="10" fill="#cbd5e1" rx="0.3" />
                <rect x="35" y="90" width="2" height="10" fill="#cbd5e1" rx="0.3" />

                {/* Optional Dynamic Reading for visual feedback */}
                {/* Now safely formats the number */}
                <text x="25" y="96" fontFamily="sans-serif" fontSize="3.5" fill="#a0d0f0" textAnchor="middle">
